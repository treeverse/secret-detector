...
import (
	...
	"github.com/treeverse/secret-detector/pkg/transformers/command"

	"gopkg.in/yaml.v3"

	"github.com/treeverse/secret-detector/pkg/detectors/artifactory"
	"github.com/treeverse/secret-detector/pkg/detectors/aws"
	"github.com/treeverse/secret-detector/pkg/detectors/azure"
	"github.com/treeverse/secret-detector/pkg/detectors/basicauth"
	"github.com/treeverse/secret-detector/pkg/detectors/bearerauth"
	"github.com/treeverse/secret-detector/pkg/detectors/generic"
	"github.com/treeverse/secret-detector/pkg/detectors/github"
	"github.com/treeverse/secret-detector/pkg/detectors/jwt"
	"github.com/treeverse/secret-detector/pkg/detectors/keyword"
	"github.com/treeverse/secret-detector/pkg/detectors/mailchimp"
	"github.com/treeverse/secret-detector/pkg/detectors/npm"
	"github.com/treeverse/secret-detector/pkg/detectors/privatekey"
	"github.com/treeverse/secret-detector/pkg/detectors/sendgrid"
	"github.com/treeverse/secret-detector/pkg/detectors/slack"
	"github.com/treeverse/secret-detector/pkg/detectors/square"
	"github.com/treeverse/secret-detector/pkg/detectors/stripe"
	"github.com/treeverse/secret-detector/pkg/detectors/twilio"
	"github.com/treeverse/secret-detector/pkg/transformers/initransformer"
	"github.com/treeverse/secret-detector/pkg/transformers/jsontransformer"
	"github.com/treeverse/secret-detector/pkg/transformers/xmltransformer"
	"github.com/treeverse/secret-detector/pkg/transformers/yamltransformer"
)
